...
namespace Uol.PagSeguro.Service
{
    ...
    public static class PreApprovalSearchService
    {
        ...
        public static PreApprovalTransaction SearchByCode(Credentials credentials, string preApprovalCode)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildSearchUrlByCode(credentials, preApprovalCode), credentials.IsSandbox()))
                {
        ...
        public static PreApprovalTransaction SearchByNofication(Credentials credentials, string notificationCode)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildSearchUrlByNotification(credentials, notificationCode), credentials.IsSandbox()))
                {
                    using (var reader = XmlReader.Create(response.GetResponseStream()))
                    {
                        var preApproval = new PreApprovalTransaction();
        ...
        public static PreApprovalSearchResult SearchByInterval(Credentials credentials, int interval)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildSearchUrlByInterval(credentials, interval), credentials.IsSandbox()))
                {
                    using (var reader = XmlReader.Create(response.GetResponseStream()))
                    {
        ...
        public static PreApprovalSearchResult SearchByDate(Credentials credentials, DateTime initialDate, DateTime finalDate, int? pageNumber = null, int? resultsPerPage = null)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildSearchUrlByDate(credentials, initialDate, finalDate, pageNumber, resultsPerPage), credentials.IsSandbox()))
                {
                    using (var reader = XmlReader.Create(response.GetResponseStream()))
                    {
                        var preApproval = new PreApprovalSearchResult();
        ...
        public static PreApprovalSearchResult SearchByReference(Credentials credentials, string reference, DateTime initialDate, DateTime finalDate, int? pageNumber = null, int? resultsPerPage = null)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildSearchUrlByReference(credentials, reference, initialDate, finalDate, pageNumber, resultsPerPage), credentials.IsSandbox()))
                {
                    using (var reader = XmlReader.Create(response.GetResponseStream()))
                    {
                        var preApproval = new PreApprovalSearchResult();
