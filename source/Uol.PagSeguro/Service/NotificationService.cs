...
namespace Uol.PagSeguro.Service
{
    ...
    public static class NotificationService
    {
        ...
        public static Transaction CheckTransaction(Credentials credentials, string notificationCode)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildTransactionNotificationUrl(credentials, notificationCode), credentials.IsSandbox()))
                {
        ...
        public static AuthorizationSummary CheckAuthorization(Credentials credentials, string notificationCode)
        {
            ...
            try
            {
                using (var response = HttpURLConnectionUtil.GetHttpGetConnection(BuildAuthorizationNotificationUrl(credentials, notificationCode), credentials.IsSandbox()))
                {
                    using (var reader = XmlReader.Create(response.GetResponseStream()))
                    {
